...
| **Croqui de medidas (réguas) + arte na própria ficha** | Preencha **Largura · Altura · Sanfona · Aba** e o sistema **desenha o croqui técnico da embalagem** com réguas de cotagem (linhas de cota com setas e as medidas), sanfona/aba tracejadas — igual ao desenho de AutoCAD. Ao lado, na **mesma tela**, um box **Arte real (anexe a imagem)** permite anexar a imagem da arte diretamente na Solicitação de Clichê — ela fica junto das medidas, é salva com a ficha e **sai na impressão** (sem precisar ir à Documentação Visual). Renderiza ao vivo. Funções: `fuCliCroqui`, `fuCliArteUpload`, `fuCliArteRender`. |
