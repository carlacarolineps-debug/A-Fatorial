...
function telaCapa() {
  ...
  // A linha sobre a contagem saiu a pedido da dona. A contagem continua
  // existindo, e continua sem guardar quem e a pessoa: nao ha IP, nao ha
  // impressao digital de navegador, so uma sessao sorteada, o aparelho e
  // de onde veio o clique. Quando existir uma pagina de privacidade na
  // landing, e la que isso passa a estar escrito.
  var rodape = '';
  ...
  return novaTela('capa',
    ...
    '</div>' +
    (rodape ? '<div class="rodape rv rv-4">' + rodape + '</div>' : ''));
}
