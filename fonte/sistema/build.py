...
print()
print('LEMBRETE: quem fecha o endereco e o Cloudflare Access, ligado em')
print('01/09. A senha de dentro diz QUEM e a pessoa e o que ela ve, e so')
print('isso: o papel filtra tela, nunca dado. Quem passa pelo Access le a')
print('rota das aplicacoes direto, cadastrada aqui dentro ou nao.')
