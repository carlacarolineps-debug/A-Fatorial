...
print()
print('LEMBRETE: o Cloudflare Access ainda nao esta criado. A senha de')
print('dentro diz QUEM e a pessoa e o que ela ve; ela nao fecha o')
print('endereco. Enquanto o Access nao existir, qualquer um que souber a')
print('URL chega ate a tela de login. Passo a passo na secao 5 do DEPLOY.md.')
